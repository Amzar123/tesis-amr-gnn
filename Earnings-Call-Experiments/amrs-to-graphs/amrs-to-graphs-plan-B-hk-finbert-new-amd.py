...
track_file = open('tracking_file_all-results_construct_hk-finbert_plan_B.txt','a+')
...
for i in range(len(filenames)):
    ...
    while(True):
        ...
        if line[:7] == "# ::tok":
            ...
            # connect previous snt_root to current snt_root
    ...
    graph_save_path = "truly-all-results-graphs-hk-finbert-plan-B/" + filename[:-3] + "pt"
